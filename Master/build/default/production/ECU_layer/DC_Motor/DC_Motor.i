...
# 1 "ECU_layer/DC_Motor/../../MCAL_layer/GPIO/Config.h" 1
...
# 47 "ECU_layer/DC_Motor/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
...
# 2 "ECU_layer/DC_Motor/DC_Motor.c" 2
...
STD_ReturnType ECU_DC_Motor_move_right(const DC_Motor_t* _dc_motor){
    ...
    if(((void*)0) == _dc_motor ){
        ...
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x00U]), GPIO_Pin_Logic_HIGH);
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x01U]), GPIO_Pin_Logic_LOW);
...
STD_ReturnType ECU_DC_Motor_move_left(const DC_Motor_t* _dc_motor){
    ...
    if(((void*)0) == _dc_motor ){
        ...
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x00U]), GPIO_Pin_Logic_LOW);
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x01U]), GPIO_Pin_Logic_HIGH);
