...
# 1 "MCAL_layer/Timer2/./../GPIO/Config.h" 1
...
# 47 "MCAL_layer/Timer2/./../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_layer/Timer2/./../Interrupts/mcal_internal_interrupts.h" 1
# 12 "MCAL_layer/Timer2/./../Interrupts/mcal_internal_interrupts.h"
...
# 53 "MCAL_layer/Timer2/./../Interrupts/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}Interrupt_Priority_Config;
# 12 "MCAL_layer/Timer2/./../Interrupts/mcal_internal_interrupts.h" 2
...
static __attribute__((inline)) void Timer2_Interrupt_Configuration(const Timer2_t *_timer2);
...
STD_ReturnType Timer2_Init (const Timer2_t *_timer2){
    ...
    if(((void*)0) == _timer2){
        ...
        (T2CONbits.T2CKPS = _timer2->Timer2_Prescaler);

        (T2CONbits.T2OUTPS = _timer2->Timer2_Postscaler);
...
STD_ReturnType Timer2_Read_Value (const Timer2_t *_timer2, uint8 *_value){
    STD_ReturnType ret = (STD_ReturnType)0x00;
    if(((void*)0) == _timer2 || ((void*)0) == _value){
        ret = (STD_ReturnType)0x00;
    }
    else{
...
static __attribute__((inline)) void Timer2_Interrupt_Configuration(const Timer2_t *_timer2){
        ...
        (PIR1bits.TMR2IF = 0);
# 122 "MCAL_layer/Timer2/hal_timer2.c"
        (INTCONbits.GIE = 1);
