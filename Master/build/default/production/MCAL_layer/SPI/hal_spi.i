...
# 11 "MCAL_layer/SPI/../std_libraries.h"
...
# 11 "MCAL_layer/SPI/../std_libraries.h" 2
...
# 1 "MCAL_layer/SPI/../GPIO/Config.h" 1
...
# 47 "MCAL_layer/SPI/../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_layer/SPI/../Interrupts/mcal_internal_interrupts.h" 1
# 12 "MCAL_layer/SPI/../Interrupts/mcal_internal_interrupts.h"
# 1 "MCAL_layer/SPI/../Interrupts/mcal_interrupt_config.h" 1
# 12 "MCAL_layer/SPI/../Interrupts/mcal_interrupt_config.h"
# 1 "MCAL_layer/SPI/../Interrupts/mcal_interrupt_gen_cfg.h" 1
# 12 "MCAL_layer/SPI/../Interrupts/mcal_interrupt_config.h" 2
# 53 "MCAL_layer/SPI/../Interrupts/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}Interrupt_Priority_Config;
# 12 "MCAL_layer/SPI/../Interrupts/mcal_internal_interrupts.h" 2
...
STD_ReturnType SPI_WriteStringBlocking (uint8 *_Byte, uint16 str_len){
    STD_ReturnType ret = (STD_ReturnType)0x00;
    uint16 l_Counter_Characters = 0;
    if(((void*)0) == _Byte){
            ret = (STD_ReturnType)0x00;
        }
    else{
        for(l_Counter_Characters = 0;l_Counter_Characters<str_len;l_Counter_Characters++){
    ...
    if(((void*)0) == _SPI){
        ...
        switch(_SPI->SPI_Mode_Variant){
            case SPI_MASTER_MODE_CLOCK_FOSC_DIV_4:
                (SSPCON1bits.SSPM = SPI_MASTER_MODE_CLOCK_FOSC_DIV_4);break;
            case SPI_MASTER_MODE_CLOCK_FOSC_DIV_16:
                (SSPCON1bits.SSPM = SPI_MASTER_MODE_CLOCK_FOSC_DIV_16);break;
            case SPI_MASTER_MODE_CLOCK_FOSC_DIV_64:
                (SSPCON1bits.SSPM = SPI_MASTER_MODE_CLOCK_FOSC_DIV_64);break;
            case SPI_MASTER_MODE_CLOCK_TMR_DIV_2:
                (SSPCON1bits.SSPM = SPI_MASTER_MODE_CLOCK_TMR_DIV_2);break;
            case SPI_SLAVE_MODE_CLOCK_SCK_SS_ENABLED:
                (SSPCON1bits.SSPM = SPI_SLAVE_MODE_CLOCK_SCK_SS_ENABLED);break;
            case SPI_SLAVE_MODE_CLOCK_SCK_SS_DISABLED:
                (SSPCON1bits.SSPM = SPI_SLAVE_MODE_CLOCK_SCK_SS_DISABLED);break;
            default: ;
        }
        ret = (STD_ReturnType)0x01;
    }
...
static STD_ReturnType SPI_Sample_Mode_Config (const SPI_Config_t *_SPI){
    ...
    if(((void*)0) == _SPI){
        ...
        switch(_SPI->SPI_Mode){
            case 0:
                (SSPSTATbits.SMP = 0);break;
            case 1:
                switch(_SPI->SPI_Sample_mode){
                    case 1:
                        (SSPSTATbits.SMP = 1);break;
                    case 0:
                        (SSPSTATbits.SMP = 0);break;
                    default: ;
                }break;
...
static STD_ReturnType SPI_Clock_Phase_Config (const SPI_Config_t *_SPI){
    ...
    if(((void*)0) == _SPI){
       ...
       switch(_SPI->SPI_Clock_Phase){
            case 1:
                (SSPSTATbits.CKE = 1);break;
            case 0:
                (SSPSTATbits.CKE = 0);break;
            default: ;
        }
       ret = (STD_ReturnType)0x01;
    }
...
static STD_ReturnType SPI_Clock_polarity_Config (const SPI_Config_t *_SPI){
    ...
    if(((void*)0) == _SPI){
       ...
       switch(_SPI->SPI_Clock_Polarity){
            case 1:
                (SSPCON1bits.CKP = 1);break;
            case 0:
                (SSPCON1bits.CKP = 0);break;
            default: ;
        }
