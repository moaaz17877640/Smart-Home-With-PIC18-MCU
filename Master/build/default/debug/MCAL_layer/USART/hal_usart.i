...
# 16 "MCAL_layer/USART/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/USART/../GPIO/Config.h" 1
...
# 17 "MCAL_layer/USART/../GPIO/hal_gpio.h" 2
# 47 "MCAL_layer/USART/../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_layer/USART/../Interrupts/mcal_internal_interrupts.h" 1
# 12 "MCAL_layer/USART/../Interrupts/mcal_internal_interrupts.h"
# 1 "MCAL_layer/USART/../Interrupts/mcal_interrupt_config.h" 1
# 12 "MCAL_layer/USART/../Interrupts/mcal_interrupt_config.h"
# 1 "MCAL_layer/USART/../Interrupts/mcal_interrupt_gen_cfg.h" 1
# 12 "MCAL_layer/USART/../Interrupts/mcal_interrupt_config.h" 2
# 53 "MCAL_layer/USART/../Interrupts/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}Interrupt_Priority_Config;
# 12 "MCAL_layer/USART/../Interrupts/mcal_internal_interrupts.h" 2
...
static void(*USART_TX_InterruptHandler)(void) = ((void*)0);


static void(*USART_RX_InterruptHandler)(void) = ((void*)0);
static void(*USART_FRE_InterruptHandler)(void) = ((void*)0);
static void(*USART_OVRR_InterruptHandler)(void) = ((void*)0);
...
static void EUSART_BaudRateCalculation(const EUSART_Config_t *_EUSART){
    ...
    switch(_EUSART->BAUDRAT_CONFIG){
        case EUSART_BAUDRAT_ASYN_8BIT_HIGH_SPEED:
            ...
            (BAUDCONbits.BRG16 = 0);
            (TXSTAbits.BRGH = 1);
            baudrate_Val = ((8000000UL/(float)_EUSART->Baud_rate) / 16) - 1;
            break;
        case EUSART_BAUDRAT_ASYN_8BIT_LOW_SPEED:
            (TXSTAbits.SYNC = 0);
            (BAUDCONbits.BRG16 = 0);
            (TXSTAbits.BRGH = 0);
            baudrate_Val = ((8000000UL/ (float)_EUSART->Baud_rate) / 64) - 1;
            break;
        case EUSART_BAUDRAT_ASYN_16BIT_HIGH_SPEED:
            (TXSTAbits.SYNC = 0);
            (BAUDCONbits.BRG16 = 1);
            (TXSTAbits.BRGH = 0);
            baudrate_Val = ((8000000UL/(float)_EUSART->Baud_rate) / 4) - 1;
            break;
...
static void EUSART_TX_Init (const EUSART_Config_t *_EUSART){
    if(_EUSART->TX_Config.Transmit_Enable){
        ...
        if(_EUSART->TX_Config.Transmit_Interrupt_Enable){
            ...
            (PIE1bits.TXIE = 0);
# 250 "MCAL_layer/USART/hal_usart.c"
            (INTCONbits.GIE = 1);
...
static void EUSART_RX_Init (const EUSART_Config_t *_EUSART){
    if(_EUSART->RX_Config.Receive_Enable){
        ...
        if(_EUSART->RX_Config.Receive_Interrupt_Enable){
            ...
            (PIE1bits.RCIE = 0);
# 312 "MCAL_layer/USART/hal_usart.c"
            (INTCONbits.GIE = 1);
