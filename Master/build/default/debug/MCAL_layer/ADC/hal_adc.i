...
# 16 "MCAL_layer/ADC/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/ADC/../GPIO/Config.h" 1
...
# 47 "MCAL_layer/ADC/../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_layer/ADC/../Interrupts/mcal_internal_interrupts.h" 1
# 12 "MCAL_layer/ADC/../Interrupts/mcal_internal_interrupts.h"
...
# 53 "MCAL_layer/ADC/../Interrupts/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}Interrupt_Priority_Config;
# 12 "MCAL_layer/ADC/../Interrupts/mcal_internal_interrupts.h" 2
...
static __attribute__((inline)) void ADC_Select_Specific_Channel(ADC_Channel_t _ADC_Channel);
static __attribute__((inline)) void ADC_Voltage_Reference_Control(const ADC_Config_t *_ADC_config);
static __attribute__((inline)) void ADC_Result_Format_Control(const ADC_Config_t *_ADC_config);
static __attribute__((inline)) void ADC_Interrupt_Configuration(const ADC_Config_t *_ADC_config);



STD_ReturnType ADC_Init (const ADC_Config_t *_ADC_config){
    STD_ReturnType ret = (STD_ReturnType)0x00;
    if(((void*)0) == _ADC_config){
...
static __attribute__((inline)) void ADC_Select_Specific_Channel(ADC_Channel_t _ADC_Channel){
    switch(_ADC_Channel){
        case ADC_CHANNEL_AN0: (TRISA |= ((uint8)1<<pin0));break;
        case ADC_CHANNEL_AN1: (TRISA |= ((uint8)1<<pin1));break;
        case ADC_CHANNEL_AN2: (TRISA |= ((uint8)1<<pin2));break;
        case ADC_CHANNEL_AN3: (TRISA |= ((uint8)1<<pin3));break;
        case ADC_CHANNEL_AN4: (TRISA |= ((uint8)1<<pin5));break;
        case ADC_CHANNEL_AN5: (TRISE |= ((uint8)1<<pin0));break;
        case ADC_CHANNEL_AN6: (TRISE |= ((uint8)1<<pin1));break;
        case ADC_CHANNEL_AN7: (TRISE |= ((uint8)1<<pin2));break;
        case ADC_CHANNEL_AN8: (TRISB |= ((uint8)1<<pin2));break;
        case ADC_CHANNEL_AN9: (TRISB |= ((uint8)1<<pin3));break;
        case ADC_CHANNEL_AN10: (TRISB |= ((uint8)1<<pin1));break;
        case ADC_CHANNEL_AN11: (TRISB |= ((uint8)1<<pin4));break;
        case ADC_CHANNEL_AN12: (TRISB |= ((uint8)1<<pin0));break;
        default: ;
    }
}
...
static __attribute__((inline)) void ADC_Voltage_Reference_Control(const ADC_Config_t *_ADC_config){
    switch(_ADC_config->Voltage_Reference){
        case DISABLE_VOLTAGE_REFERENCE: do{ ADCON1bits.VCFG0 = 0; ADCON1bits.VCFG1 = 0; }while(0);break;
        case ENABLE_VOLTAGE_REFERENCE: do{ ADCON1bits.VCFG0 = 1; ADCON1bits.VCFG1 = 1; }while(0);break;
        default: ;
    }
}
...
static __attribute__((inline)) void ADC_Result_Format_Control(const ADC_Config_t *_ADC_config){
    switch(_ADC_config->Result_Format){
        case ADC_RESULT_FORMAT_LEFT: (ADCON2bits.ADFM = 0);break;
        case ADC_RESULT_FORMAT_RIGHT: (ADCON2bits.ADFM = 1);break;
        default: ;
    }
}
