...
# 1 "MCAL_layer/Timer3/./../GPIO/Config.h" 1
...
# 47 "MCAL_layer/Timer3/./../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_layer/Timer3/./../Interrupts/mcal_internal_interrupts.h" 1
# 12 "MCAL_layer/Timer3/./../Interrupts/mcal_internal_interrupts.h"
...
# 53 "MCAL_layer/Timer3/./../Interrupts/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}Interrupt_Priority_Config;
# 12 "MCAL_layer/Timer3/./../Interrupts/mcal_internal_interrupts.h" 2
...
static __attribute__((inline)) void Timer3_Set_Resolution(const Timer3_t *_timer3);
static __attribute__((inline)) void Timer3_Set_Mode(const Timer3_t *_timer3);
static __attribute__((inline)) void Timer3_Interrupt_Configuration(const Timer3_t *_timer3);
...
STD_ReturnType Timer3_Read_Value (const Timer3_t *_timer3, uint16 *_value){
    STD_ReturnType ret = (STD_ReturnType)0x00;
    uint8 l_timer3l = 0, l_timer3h = 0;
    if(((void*)0) == _timer3 || ((void*)0) == _value){
        ret = (STD_ReturnType)0x00;
    }
    else{
        l_timer3l = TMR3L;
...
static __attribute__((inline)) void Timer3_Set_Resolution(const Timer3_t *_timer3){
    switch(_timer3->Timer3_registerSize){
        case 0: (T3CONbits.RD16 = 0);break;
        case 1: (T3CONbits.RD16 = 1);break;
        default: ;
    }
}
...
static __attribute__((inline)) void Timer3_Set_Mode(const Timer3_t *_timer3){
    switch(_timer3->Timer3_mode){
        case 0: (T3CONbits.TMR3CS = 0);break;
        case 1:
            (T3CONbits.TMR3CS = 1);
            switch(_timer3->Timer3_Sync_Counter){
                case 0:
                    (T3CONbits.T3SYNC = 0);break;
                case 1:
                    (T3CONbits.T3SYNC = 1);break;
                default: ;
            }break;
        default: ;
    }
...
static __attribute__((inline)) void Timer3_Interrupt_Configuration(const Timer3_t *_timer3){
        ...
        (PIR2bits.TMR3IF = 0);
# 158 "MCAL_layer/Timer3/hal_timer3.c"
        (INTCONbits.GIE = 1);
