...
typedef struct{
    ...
    pinConfig_t KeypadColoumnsConfig[3];
}KeyPad_t;
...
void WrongPassword(void){
    ...
    ret = ECU_LCD_4Bit_Send_String_Data_Postition(&LCD_1, 1, 3, "Wrong password!!!");
    _delay((unsigned long)((500)*(8000000/4000.0)));
    while(1){
        ret = ECU_LCD_4Bit_Send_Command(&LCD_1, 0x01);
    }
}
...
# 180 "main.c"
    ...
    ret = ECU_LCD_4Bit_Send_String_Data_Postition(&LCD_1, 1, 3, "Enter the password");
    ...
    while (1)
    {
        ...
        while(NumberPressed !='\0'){
            ...
            _delay((unsigned long)((550)*(8000000/4000.0)));
            currentPassword[LCD_curser] = NumberPressed;
            ret = ECU_LCD_4Bit_Send_char_Data_Position(&LCD_1, 2, LCD_curser+2, '*');
            LCD_curser++;
