# 1 "ECU_layer/Seven_Segment_Display/Seg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_layer/Seven_Segment_Display/Seg.c" 2

# 1 "ECU_layer/Seven_Segment_Display/Seg.h" 1
# 12 "ECU_layer/Seven_Segment_Display/Seg.h"
# 1 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/hal_gpio.h" 1
# 15 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../mcal_std_types.h" 1
# 12 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../mcal_std_types.h"
# 1 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../compiler.h" 1
# 11 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../compiler.h"
...
# 11 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../compiler.h" 2
# 12 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../mcal_std_types.h" 2

# 1 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../std_libraries.h" 1
# 11 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../std_libraries.h"
...
# 11 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 13 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../std_libraries.h" 2
# 13 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 15 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/Config.h" 1
# 16 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/hal_gpio.h" 2
...
# 17 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/hal_gpio.h" 2
# 47 "ECU_layer/Seven_Segment_Display/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
...
# 12 "ECU_layer/Seven_Segment_Display/Seg.h" 2
...
# 2 "ECU_layer/Seven_Segment_Display/Seg.c" 2
...
STD_ReturnType ECU_Segment_initialize(const Segment_Config_t *_Segment){
    STD_ReturnType rt = (STD_ReturnType)0x00;
     if(((void*)0) == _Segment ){
        ...
        gpio_pin_initialize(&(_Segment->Segment_pins[0]));
        gpio_pin_initialize(&(_Segment->Segment_pins[1]));
        gpio_pin_initialize(&(_Segment->Segment_pins[2]));
        gpio_pin_initialize(&(_Segment->Segment_pins[3]));
...
STD_ReturnType ECU_Segment_write(const Segment_Config_t *_Segment, uint8 Segment_write){
    STD_ReturnType rt = (STD_ReturnType)0x00;
     if(((void*)0) == _Segment ){
        ...
        gpio_pin_write_logic (&(_Segment->Segment_pins[0]), (Segment_write) & 0x01 );
        gpio_pin_write_logic (&(_Segment->Segment_pins[1]), (Segment_write>>1) & 0x01 );
        gpio_pin_write_logic (&(_Segment->Segment_pins[2]), (Segment_write>>2) & 0x01 );
        gpio_pin_write_logic (&(_Segment->Segment_pins[3]), (Segment_write>>3) & 0x01 );
