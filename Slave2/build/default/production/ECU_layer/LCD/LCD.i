...
# 15 "ECU_layer/LCD/./../../MCAL_layer/GPIO/hal_gpio.h"
...
# 1 "ECU_layer/LCD/./../../MCAL_layer/GPIO/Config.h" 1
...
# 47 "ECU_layer/LCD/./../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
...
STD_ReturnType ECU_LCD_4Bit_Initialize (const LCD_Config_4Bit_Mode_t *_LCD){
    ...
    if(((void*)0) == _LCD ){
       rt = (STD_ReturnType)0x00;
        ...
        rt = ECU_LCD_4Bit_Send_Command(_LCD,0x38);
        _delay((unsigned long)((4.1)*(8000000UL/4000.0)));
        rt = ECU_LCD_4Bit_Send_Command(_LCD,0x38);
        _delay((unsigned long)((100)*(8000000UL/4000000.0)));
        rt = ECU_LCD_4Bit_Send_Command(_LCD,0x38);

        rt = ECU_LCD_4Bit_Send_Command(_LCD,0x01);
        rt = ECU_LCD_4Bit_Send_Command(_LCD,0x02);
        rt = ECU_LCD_4Bit_Send_Command(_LCD,0x06);
        rt = ECU_LCD_4Bit_Send_Command(_LCD,0x0C);
        rt = ECU_LCD_4Bit_Send_Command(_LCD,0x28);
        rt = ECU_LCD_4Bit_Send_Command(_LCD,0x80);
    }
    ...
    uint8 LCD_Counter = 0;
     if(((void*)0) == _LCD){
        rt = (STD_ReturnType)0x00;
         ...
         rt = ECU_LCD_4Bit_Send_Command(_LCD , (0x40 +(mem_pos*8)));
...
STD_ReturnType ECU_LCD_8Bit_Initialize(const LCD_Config_8Bit_Mode_t *_LCD){
    ...
    if(((void*)0) == _LCD){
        ...
        ret = ECU_LCD_8Bit_Send_Command(_LCD, 0x38);
        _delay((unsigned long)((5)*(8000000UL/4000.0)));
        ret = ECU_LCD_8Bit_Send_Command(_LCD, 0x38);
        _delay((unsigned long)((150)*(8000000UL/4000000.0)));
        ret = ECU_LCD_8Bit_Send_Command(_LCD, 0x38);

        ret = ECU_LCD_8Bit_Send_Command(_LCD, 0x01);
        ret = ECU_LCD_8Bit_Send_Command(_LCD, 0x02);
        ret = ECU_LCD_8Bit_Send_Command(_LCD, 0x06);
        ret = ECU_LCD_8Bit_Send_Command(_LCD, 0x0C);
        ret = ECU_LCD_8Bit_Send_Command(_LCD, 0x38);
    ...
    uint8 LCD_Counter = 0;
     if(((void*)0) == _LCD){
        rt = (STD_ReturnType)0x00;
         ...
         rt = ECU_LCD_8Bit_Send_Command(_LCD , (0x40 +(mem_pos*8)));
         for(LCD_Counter=0 ; LCD_Counter<8 ; ++LCD_Counter){
