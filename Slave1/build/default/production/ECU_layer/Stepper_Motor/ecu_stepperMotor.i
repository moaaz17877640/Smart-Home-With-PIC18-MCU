# 1 "ECU_layer/Stepper_Motor/ecu_stepperMotor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_layer/Stepper_Motor/ecu_stepperMotor.c" 2
...
# 12 "ECU_layer/Stepper_Motor/ecu_stepperMotor.h"
# 1 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/hal_gpio.h" 1
# 15 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../mcal_std_types.h" 1
# 12 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../mcal_std_types.h"
# 1 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../compiler.h" 1
# 11 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../compiler.h"
...
# 11 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../compiler.h" 2
# 12 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../mcal_std_types.h" 2

# 1 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../std_libraries.h" 1
# 11 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../std_libraries.h"
...
# 11 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 13 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../std_libraries.h" 2
# 13 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 15 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/Config.h" 1
# 16 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/hal_gpio.h" 2
...
# 17 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/hal_gpio.h" 2
# 47 "ECU_layer/Stepper_Motor/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
...
# 12 "ECU_layer/Stepper_Motor/ecu_stepperMotor.h" 2
...
# 8 "ECU_layer/Stepper_Motor/ecu_stepperMotor.c" 2


STD_ReturnType ECU_STEPPER_Motor_initialize(const stepper_Motor_t* _stepper_motor){
    STD_ReturnType rt = (STD_ReturnType)0x00;
     if(((void*)0) == _stepper_motor ){
        rt = (STD_ReturnType)0x00;
    }
    else{
        gpio_pin_direction_initialize(&(_stepper_motor->stepper_motor_pin[0x00U]));
        gpio_pin_direction_initialize(&(_stepper_motor->stepper_motor_pin[0x01U]));
        gpio_pin_direction_initialize(&(_stepper_motor->stepper_motor_pin[0x02U]));
        gpio_pin_direction_initialize(&(_stepper_motor->stepper_motor_pin[0x03U]));
...
STD_ReturnType ECU_STEPPER_Motor_move_left(const stepper_Motor_t* _stepper_motor, uint16 _angle){
    ...
    if(((void*)0) == _stepper_motor){
        ...
        for(iter = 0 ; iter < noOfIterations ; iter++){
            rt = gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x00U]), GPIO_Pin_Logic_LOW);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x01U]), GPIO_Pin_Logic_HIGH);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x02U]), GPIO_Pin_Logic_HIGH);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x03U]), GPIO_Pin_Logic_HIGH);

            _delay((unsigned long)((10)*(8000000UL/4000.0)));

            rt = gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x00U]), GPIO_Pin_Logic_HIGH);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x01U]), GPIO_Pin_Logic_LOW);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x02U]), GPIO_Pin_Logic_HIGH);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x03U]), GPIO_Pin_Logic_HIGH);
            ...
            rt = gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x00U]), GPIO_Pin_Logic_HIGH);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x01U]), GPIO_Pin_Logic_HIGH);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x02U]), GPIO_Pin_Logic_LOW);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x03U]), GPIO_Pin_Logic_HIGH);
            ...
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x01U]), GPIO_Pin_Logic_HIGH);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x02U]), GPIO_Pin_Logic_HIGH);
            rt |= gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x03U]), GPIO_Pin_Logic_LOW);
...
STD_ReturnType ECU_STEPPER_Motor_stop(const stepper_Motor_t* _stepper_motor){
    ...
    if(((void*)0) == _stepper_motor ){
        ...
        gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x00U]), GPIO_Pin_Logic_HIGH);
        gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x01U]), GPIO_Pin_Logic_HIGH);
        gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x02U]), GPIO_Pin_Logic_HIGH);
        gpio_pin_write_logic(&(_stepper_motor->stepper_motor_pin[0x03U]), GPIO_Pin_Logic_HIGH);
