...
# 1 "MCAL_layer/Timer0/./../GPIO/Config.h" 1
...
# 47 "MCAL_layer/Timer0/./../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_layer/Timer0/./../Interrupts/mcal_internal_interrupts.h" 1
# 12 "MCAL_layer/Timer0/./../Interrupts/mcal_internal_interrupts.h"
...
# 53 "MCAL_layer/Timer0/./../Interrupts/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}Interrupt_Priority_Config;
# 12 "MCAL_layer/Timer0/./../Interrupts/mcal_internal_interrupts.h" 2
...
static __attribute__((inline)) void Timer0_Set_Resolution(const Timer0_t *_timer0);
static __attribute__((inline)) void Timer0_Set_Mode(const Timer0_t *_timer0);
static __attribute__((inline)) void Timer0_Prescaler_Config(const Timer0_t *_timer0);
static __attribute__((inline)) void Timer0_Interrupt_Configuration(const Timer0_t *_timer0);
...
STD_ReturnType Timer0_Write_Value (const Timer0_t *_timer0, uint16 _value){
    ...
    if(((void*)0) == _timer0){
        ...
        if(1 == _timer0->Timer0_registerSize){
            TMR0L = (uint8)(_value);
        }
        else if(0 == _timer0->Timer0_registerSize){
...
STD_ReturnType Timer0_Read_Value (const Timer0_t *_timer0, uint16 *_value){
    STD_ReturnType ret = (STD_ReturnType)0x00;
    uint8 l_timer0l = 0, l_timer0h = 0;
    if(((void*)0) == _timer0 || ((void*)0) == _value){
        ret = (STD_ReturnType)0x00;
    }
    else{
        if(1 == _timer0->Timer0_registerSize){
...
static __attribute__((inline)) void Timer0_Set_Resolution(const Timer0_t *_timer0){
    switch(_timer0->Timer0_registerSize){
        case 1: (T0CONbits.T08BIT = 1);break;
        case 0: (T0CONbits.T08BIT = 0);break;
        default: ;
    }
}
...
static __attribute__((inline)) void Timer0_Set_Mode(const Timer0_t *_timer0){
    switch(_timer0->Timer0_mode){
        case 0: (T0CONbits.T0CS = 0);break;
        case 1:
            (T0CONbits.T0CS = 1);
            switch(_timer0->Timer0_counterEdge){
                case 1:
                    (T0CONbits.T0SE = 1);break;
                case 0:
                    (T0CONbits.T0SE = 0);break;
                default: ;
            }break;
        default: ;
    }
...
static __attribute__((inline)) void Timer0_Interrupt_Configuration(const Timer0_t *_timer0){
        ...
        (INTCONbits.TMR0IF = 0);
# 190 "MCAL_layer/Timer0/hal_timer0.c"
        (INTCONbits.GIE = 1);
