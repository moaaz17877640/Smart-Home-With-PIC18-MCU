...
# 1 "MCAL_layer/Timer1/./../GPIO/Config.h" 1
...
# 47 "MCAL_layer/Timer1/./../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_layer/Timer1/./../Interrupts/mcal_internal_interrupts.h" 1
# 12 "MCAL_layer/Timer1/./../Interrupts/mcal_internal_interrupts.h"
...
# 53 "MCAL_layer/Timer1/./../Interrupts/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}Interrupt_Priority_Config;
# 12 "MCAL_layer/Timer1/./../Interrupts/mcal_internal_interrupts.h" 2
# 14 "MCAL_layer/Timer1/hal_timer1.h" 2
# 90 "MCAL_layer/Timer1/hal_timer1.h"
typedef struct {
...
static __attribute__((inline)) void Timer1_Set_Resolution(const Timer1_t *_timer1);
static __attribute__((inline)) void Timer1_Set_Mode(const Timer1_t *_timer1);
static __attribute__((inline)) void Timer1_Interrupt_Configuration(const Timer1_t *_timer1);
...
STD_ReturnType Timer1_Read_Value (const Timer1_t *_timer1, uint16 *_value){
    STD_ReturnType ret = (STD_ReturnType)0x00;
    uint8 l_timer1l = 0, l_timer1h = 0;
    if(((void*)0) == _timer1 || ((void*)0) == _value){
        ret = (STD_ReturnType)0x00;
    }
    else{
        l_timer1l = TMR1L;
...
static __attribute__((inline)) void Timer1_Set_Resolution(const Timer1_t *_timer1){
    switch(_timer1->Timer1_registerSize){
        case 0: (T1CONbits.RD16 = 0);break;
        case 1: (T1CONbits.RD16 = 1);break;
        default: ;
    }
}
...
static __attribute__((inline)) void Timer1_Set_Mode(const Timer1_t *_timer1){
    switch(_timer1->Timer1_mode){
        case 0: (T1CONbits.TMR1CS = 0);break;
        case 1:
            (T1CONbits.TMR1CS = 1);
            switch(_timer1->Timer1_OSC_Counter){
                case 1:
                    (T1CONbits.T1OSCEN = 1);break;
                case 0:
                    (T1CONbits.T1OSCEN = 0);break;
                default: ;
            };
            switch(_timer1->Timer1_Sync_Counter){
                case 0:
                    (T1CONbits.T1SYNC = 0);break;
                case 1:
                    (T1CONbits.T1SYNC = 1);break;
                default: ;
            }break;
        default: ;
    }
...
static __attribute__((inline)) void Timer1_Interrupt_Configuration(const Timer1_t *_timer1){
        ...
        (PIR1bits.TMR1IF = 0);
# 168 "MCAL_layer/Timer1/hal_timer1.c"
        (INTCONbits.GIE = 1);
