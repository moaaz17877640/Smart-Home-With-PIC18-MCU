...
# 1 "MCAL_layer/I2C/../GPIO/Config.h" 1
...
# 47 "MCAL_layer/I2C/../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_layer/I2C/../Interrupts/mcal_internal_interrupts.h" 1
# 12 "MCAL_layer/I2C/../Interrupts/mcal_internal_interrupts.h"
# 1 "MCAL_layer/I2C/../Interrupts/mcal_interrupt_config.h" 1
# 12 "MCAL_layer/I2C/../Interrupts/mcal_interrupt_config.h"
# 1 "MCAL_layer/I2C/../Interrupts/mcal_interrupt_gen_cfg.h" 1
# 12 "MCAL_layer/I2C/../Interrupts/mcal_interrupt_config.h" 2
# 53 "MCAL_layer/I2C/../Interrupts/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}Interrupt_Priority_Config;
# 12 "MCAL_layer/I2C/../Interrupts/mcal_internal_interrupts.h" 2
...
STD_ReturnType I2C_Init (const I2C_Config_t *_I2C){
    ...
    if(((void*)0) == _I2C){
        ...
        if(1 == _I2C->I2C_Slew_Rate){
            (SSPSTATbits.SMP = 1);
        }
        else if(0 == _I2C->I2C_Slew_Rate){
            (SSPSTATbits.SMP = 0);
        }
        else{ }
...
static void I2C_Master_Mode_Configuration(const I2C_Config_t *_I2C){
    (SSPCON1bits.SSPM = _I2C->I2C_Mode_Variant);
