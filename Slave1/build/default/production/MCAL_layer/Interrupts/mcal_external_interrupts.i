# 1 "MCAL_layer/Interrupts/mcal_external_interrupts.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_layer/Interrupts/mcal_external_interrupts.c" 2
...
# 12 "MCAL_layer/Interrupts/mcal_external_interrupts.h"
...
# 12 "MCAL_layer/Interrupts/../mcal_std_types.h"
# 1 "MCAL_layer/Interrupts/../compiler.h" 1
# 11 "MCAL_layer/Interrupts/../compiler.h"
...
# 11 "MCAL_layer/Interrupts/../compiler.h" 2
# 12 "MCAL_layer/Interrupts/../mcal_std_types.h" 2

# 1 "MCAL_layer/Interrupts/../std_libraries.h" 1
# 11 "MCAL_layer/Interrupts/../std_libraries.h"
...
# 11 "MCAL_layer/Interrupts/../std_libraries.h" 2
...
# 13 "MCAL_layer/Interrupts/../std_libraries.h" 2
# 13 "MCAL_layer/Interrupts/../mcal_std_types.h" 2
...
# 16 "MCAL_layer/Interrupts/./../GPIO/hal_gpio.h"
# 1 "MCAL_layer/Interrupts/./../GPIO/Config.h" 1
# 16 "MCAL_layer/Interrupts/./../GPIO/hal_gpio.h" 2
...
# 17 "MCAL_layer/Interrupts/./../GPIO/hal_gpio.h" 2
# 47 "MCAL_layer/Interrupts/./../GPIO/hal_gpio.h"
typedef enum{
...
# 14 "MCAL_layer/Interrupts/mcal_interrupt_config.h" 2
# 53 "MCAL_layer/Interrupts/mcal_interrupt_config.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
}Interrupt_Priority_Config;
# 12 "MCAL_layer/Interrupts/mcal_external_interrupts.h" 2
...
# 8 "MCAL_layer/Interrupts/mcal_external_interrupts.c" 2
...
static InterruptHandler Interrupt_INT0_Handler = ((void*)0);
static InterruptHandler Interrupt_INT1_Handler = ((void*)0);
static InterruptHandler Interrupt_INT2_Handler = ((void*)0);
...
static InterruptHandler Interrupt_RB4_Handler_HIGH = ((void*)0);
static InterruptHandler Interrupt_RB4_Handler_LOW = ((void*)0);
static InterruptHandler Interrupt_RB5_Handler_HIGH = ((void*)0);
static InterruptHandler Interrupt_RB5_Handler_LOW = ((void*)0);
static InterruptHandler Interrupt_RB6_Handler_HIGH = ((void*)0);
static InterruptHandler Interrupt_RB6_Handler_LOW = ((void*)0);
static InterruptHandler Interrupt_RB7_Handler_HIGH = ((void*)0);
static InterruptHandler Interrupt_RB7_Handler_LOW = ((void*)0);
    ...
    if(((void*)0) == INTx){
        ...
        switch(INTx->Interrupt_Source){
            case EXTERNAL_INTERRUPT_INT0:
                if(INTERRUPT_FAILLING_EDGE == INTx->Interrupt_Edge){(INTCON2bits.INTEDG0 = 0);}
                else if(INTERRUPT_RAISING_EDGE == INTx->Interrupt_Edge){(INTCON2bits.INTEDG0 = 1);}
                else { }
                ret = (STD_ReturnType)0x01;
                break;
            case EXTERNAL_INTERRUPT_INT1:
                if(INTERRUPT_FAILLING_EDGE == INTx->Interrupt_Edge){(INTCON2bits.INTEDG1 = 0);}
                else if(INTERRUPT_RAISING_EDGE == INTx->Interrupt_Edge){(INTCON2bits.INTEDG1 = 1);}
                else { }
                ret = (STD_ReturnType)0x01;
                break;
            case EXTERNAL_INTERRUPT_INT2:
                if(INTERRUPT_FAILLING_EDGE == INTx->Interrupt_Edge){(INTCON2bits.INTEDG2 = 0);}
                else if(INTERRUPT_RAISING_EDGE == INTx->Interrupt_Edge){(INTCON2bits.INTEDG2 = 1);}
                else { }
                ret = (STD_ReturnType)0x01;
                break;
            default:
...
static STD_ReturnType Interrupt_INTx_Priority_Init(const External_INTx_t *INTx){
    ...
    if(((void*)0) == INTx){
        ...
        switch(INTx->Interrupt_Source){
            ...
            case EXTERNAL_INTERRUPT_INT1:
                ret = (STD_ReturnType)0x01;
# 259 "MCAL_layer/Interrupts/mcal_external_interrupts.c"
                (INTCONbits.GIE = 1);
            ...
            case EXTERNAL_INTERRUPT_INT2:
                ret = (STD_ReturnType)0x01;
# 284 "MCAL_layer/Interrupts/mcal_external_interrupts.c"
                (INTCONbits.GIE = 1);
...
# 482 "MCAL_layer/Interrupts/mcal_external_interrupts.c"
        (INTCONbits.GIE = 1);
